...
class AutoPause {
  ...
  run(player) {
    ...
    observer.observe(player.media); // VisibilityChange - Nos sirve para saber si el Tab donde estqa nuestra pagina es el que esta observando el usuario,
