...
self.addEventListener("fetch", event => {
  const request = event.request; // Evaluamos si el metodo de la peticion es GET
...
async function precache() {
  ...
  cache.addAll(['/', '/index.html', '/assets/index.js', '/assets/MediaPlayer.js', '/assets/plugins/AutoPlay.js', '/assets/plugins/AutoPause.js', '/assets/index.css', '/assets/BigBuckBunny.mp4']);
}
